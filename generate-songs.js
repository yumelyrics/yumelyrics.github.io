...
<div id="lyrView">
  ...
  <div class="lvgrid">
    ...
    <div>
      ...
      <div id="login-gate">
        <div id="login-gate-title">Login & komentar untuk copy lirik</div>
        <div id="login-gate-sub">Lirik bisa dibaca tanpa login. Login dengan Google untuk copy lirik (setelah komentar)</div>
...
let _isAdmin = false;
const ADMIN_EMAIL = "admin@yumesubs.com";
