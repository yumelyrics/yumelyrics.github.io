...
<section class="comments-section">
  <div class="comment-intro">
    ...
    <div>
      <p class="comment-desc">Bagikan pendapatmu lewat Waline — bebas sebagai tamu atau setelah login.</p>
    </div>
  </div>
  <div id="waline"></div>
</section>
...
<div id="editProfileModal">
  <div class="ep-box">
    ...
    <div class="ep-avatar-wrap" id="ep-avatar-wrap-big">
      <div class="ep-avatar-big ep-avatar-placeholder-big" id="ep-avatar-big" aria-hidden="true"></div>
      <div class="ep-info">
    ...
    <div class="ep-note">Nama &amp; foto di sini untuk profil situs (bubble kanan bawah). Komentar GraphComment pakai akun tamu/login di panel GraphComment — upload foto di sana jika ingin beda.</div>
...
function showCopyCommentToast() { /* copy gate dihapus — semua user bisa copy */ }
...
function renderAvatarEl(wrap, photoURL, displayName, imgClass, phClass){
  ...
  if(url){
    ...
    img.onerror = function(){
      img.onerror = null;
      if (DEFAULT_COMMENT_PROFILE && img.src !== DEFAULT_COMMENT_PROFILE) {
