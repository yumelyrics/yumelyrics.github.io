...
.series-cover-col{flex-shrink:0;width:220px;position:relative;overflow:hidden;background:var(--cream);padding:14px}
.series-cover-bg{display:none}
.series-cover-img{position:relative;z-index:1;width:100%;height:100%;object-fit:cover;display:block;border-radius:2px}
...
<div class="series-hero">
  <div class="series-cover-col">
    ${cover
      ? `<div class="series-cover-bg" style="background-image:url('${escHtml(wsrvUrl(cover, 60))}')"></div><img class="series-cover-img" src="${escHtml(wsrvUrl(cover, 440))}" alt="${escHtml(title)}" width="220" loading="eager" decoding="async" fetchpriority="high">`
